    ...
    <div class="container-custom py-12 md:py-16">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
        ...
        <div>
          ...
          <p class="text-gray-400 mb-6">{{ t('meta.description') }}</p>
          ...
          <ul class="space-y-2">
            ...
            <li>
              <a
                href="#"
                class="text-gray-400 hover:text-white transition-colors duration-200"
                >{{ t('footer.links.accessibility') }}</a
              >
            </li>
          </ul>
        </div>
          ...
          <form @submit.prevent="handleSubscribe" class="space-y-4">
            <div>
              ...
              <input
                ...
                v-model="email"
                required
                class="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
            ...
            <div>
              <button
                type="submit"
                class="w-full px-4 py-2 bg-primary-500 hover:bg-primary-600 rounded-md text-white font-medium transition-colors duration-200"
              >
            ...
            <p v-if="subscribeStatus === 'error'" class="text-red-400 text-sm">
      ...
      >
        ...
        <div class="mt-4 md:mt-0">
          <router-link
            to="/privacy"
            class="inline-block px-2 py-1 text-sm text-gray-400 hover:text-white transition-colors duration-200"
          >
            {{ t('footer.links.privacy') }}
          </router-link>
          <router-link
